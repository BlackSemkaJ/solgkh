                                        ...
                                        <div class="submenu">
                                            <div class="submenu-3">
                                                <ul class="menu_level_2 list-reset">
                                                    <li class="item_2">
                                                        <a href="#"><span>О предприятии</span></a>
                                                    </li>
                                                    <li class="item_2">
                                                        <a href="#"><span>Вышестоящие организации</span></a>
                                                    </li>
                                                    <li class="item_2">
                                                        <a href="#"><span>Структура предприятия</span></a>
                                                    </li>
                                                    <li class="item_2">
                                                        <a href="#">
                                                        ...
                                                        <div class="submenu-inner">
                                                            <ul class="menu_level_3 list-reset">
                                                                <li class="item_3">
                                                                    <a href="#"><span>Электронное обращение для юр.лиц</span></a>   
                                                                </li>
                                                                <li class="item_3">
                                                                    <a href="#"><span>Электронное обращение для физ.лиц</span></a>   
                                                                </li>
                                                                <li class="item_3">
                                                                    <a href="#"><span>Приём граждан, их представителей, представителей юридических лиц</span></a>   
                                                                </li>
                                                                <li class="item_3">
                                                                    <a href="#"><span>Прямые телефонные линии</span></a>   
                                                                </li>   
                                                            </ul>
                                                        </div>
                                                    </li>
                                                    <li class="item_2">
                                                        ...
                                                        <div class="submenu-inner">
                                                            <ul class="menu_level_3 list-reset">
                                                                <li class="item_3">
                                                                    <a href="#"><span>План работы комиссии</span></a>   
                                                                </li>
                                                                <li class="item_3">
                                                                    <a href="#"><span>Заседание комиссии</span></a>   
                                                                </li>
                                                            </ul>
                                                        </div>
                                                    </li>
                                    ...
                                    <li class="item_1 has-submenu">
                                        ...
                                        <div class="submenu">
                                            <div class="submenu-3">
                                                <ul class="menu_level_2 list-reset">
                                                    <li class="item_2">
                                                        <a href="#"><span>Административные процедуры</span></a>
                                                    </li>
                                                    <li class="item_2">
                                                        <a href="#"><span>Тарифы</span></a>
                                                    </li>
                                                    <li class="item_2">
                                                        <a href="#"><span>Оплата услуг</span></a>
                                                    </li>
                                                    <li class="item_2">
                                                        <a href="#"><span>Сроки выполнения заявок по виду работ</span></a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                                    ...
                                    <li class="item_1 has-submenu">
                                        ...
                                        <div class="submenu">
                                            <div class="submenu-3">
                                                <ul class="menu_level_2 list-reset">
                                                    <li class="item_2">
                                                        <a href="#"><span>Благоустройство</span></a>
                                                    </li>
                                                    <li class="item_2">
                                                        <a href="#"><span>Требования по содержанию жилфонда</span></a>
                                                    </li>
                                                    <li class="item_2">
                                                        <a href="#"><span>Правила пользования жилыми помещениями</span></a>
                                                    </li>
                                                    <li class="item_2">
                                                        <a href="#"><span>Перечень объектов по текущему ремонту подъездов жилищного фонда СГУПП «ЖКХ«Комплекс» на 2022г.</span></a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                                    ...
                                    <li class="item_1 has-submenu">
                                        ...
                                        <div class="submenu">
                                            <div class="submenu-3">
                                                <ul class="menu_level_2 list-reset">
                                                    <li class="item_2">
                                                        <a href="#"><span>О профилактики коронавирусной инфекции</span></a>
                                                    </li>
                                                    <li class="item_2">
                                                        <a href="#"><span>О работе с молодежью в первичной профсоюзной организации СГУПП «ЖКХ«Комплекс».</span></a>
                                                    </li>
                                                    <li class="item_2">
                                                        <a href="#"><span>БРСМ</span></a>
                                                    </li>
                                                    <li class="item_2">
                                                        <a href="#"><span>Новости профосюзного комитета</span></a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
...
<style scoped>
    ...
    .submenu-3 [class*=item_]>a .icon, .submenu-3 [class*=item_]>span .icon {
        width: 0;
        height: 0;
        border-style: solid;
    ...
    .submenu-3 [class*=item_]:focus>.submenu-inner, .submenu-3 [class*=item_]:hover>.submenu-inner {
        display: block;
    }
    ...
    .submenu-3 [class*=item_]>a:focus, .submenu-3 [class*=item_]>a:hover {
        color: #7c4da7;
        background: 0 0;
    }
    /* Поиск ----------------------------------------*/
    ...
    .search-head-4 .btn-open:before {
        content: ' ';
        display: inline-block;
        background-image: url(data:image/svg+xml,%3Csvg%20width%3D%2225%22%20height%3D%2225%22%20viewBox%3D%22-1%20-1%2025%2025%22%20fill%3D%22none%22%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%3E%3Cg%20opacity%3D%22.5%22%20fill-rule%3D%22evenodd%22%20clip-rule%3D%22evenodd%22%20fill%3D%22%23000%22%3E%3Cpath%20d%3D%22M10.354%2020.856c5.241%200%209.49-4.466%209.49-9.974%200-5.51-4.249-9.975-9.49-9.975C5.112.907.863%205.373.863%2010.882c0%205.508%204.249%209.974%209.49%209.974zm0%20.907c5.718%200%2010.354-4.872%2010.354-10.881C20.707%204.872%2016.072%200%2010.354%200%204.636%200%200%204.872%200%2010.882s4.636%2010.881%2010.354%2010.881z%22%2F%3E%3Cpath%20d%3D%22M22.693%2022.68a.417.417%200%200%201-.61%200l-4.27-4.488a.47.47%200%200%201%200-.64.417.417%200%200%201%20.61%200l4.27%204.488a.47.47%200%200%201%200%20.64z%22%2F%3E%3C%2Fg%3E%3C%2Fsvg%3E);
        width: 25px;
        height: 25px;
        display: block;
        transition: all .25s ease;
